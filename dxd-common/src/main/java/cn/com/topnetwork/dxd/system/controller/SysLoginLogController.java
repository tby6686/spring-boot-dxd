...
import cn.com.topnetwork.dxd.log.enu.OperationLogType;
...
public class SysLoginLogController extends BaseController {
    ...
    @OperationLog(name = "系统登录日志分页列表", type = OperationLogType.QUERY_LIST)
    @ApiOperation(value = "系统登录日志分页列表", response = ApiResult.class)
    public ApiResult<PageInfo<SysLoginLogVo>> getSysLoginLogPageList(@Validated @RequestBody SysLoginLogPageParam sysLoginLogPageParam){
        PageInfo<SysLoginLogVo> pageInfo = sysLoginLogService.queryPageListByParam(sysLoginLogPageParam);

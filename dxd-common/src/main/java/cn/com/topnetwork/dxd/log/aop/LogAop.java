...
@Aspect
@Component
@ConditionalOnProperty(value = {"spring-boot-dxd.aop.log.enable"}, matchIfMissing = true)
public class LogAop extends BaseLogAop {

    /**
     * 切点
     */
   private static final String POINTCUT = "execution(public * cn.com.topnetwork.dxd..*.controller.LoginController.*(..)) || " +
        "@annotation(cn.com.topnetwork.dxd.log.annotation.OperationLog)";

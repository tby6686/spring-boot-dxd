 ...
 */
@Slf4j
//@ConditionalOnProperty(value = {"spring-boot-dxd.interceptor.resource.enable"}, matchIfMissing = true)
public class ResourceInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 资源拦截器，业务处理代码
        log.debug("ResourceInterceptor preHandle...");
...
//         String token = request.getParameter(JwtTokenUtil.getTokenName());
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        // 记录实际访问图片日志...
        log.debug("ResourceInterceptor postHandle...");
    }
}

...
public class SysOperationLogController extends BaseController {
    ...
    @ApiOperation(value = "系统操作日志分页列表", response = ApiResult.class)
    public ApiResult<PageInfo<SysOperationLogVo>> getSysOperationLogPageList(@Validated @RequestBody SysOperationLogPageParam sysOperationLogPageParam){
        PageInfo<SysOperationLogVo> pageInfo = sysOperationLogService.queryPageListByParam(sysOperationLogPageParam);
